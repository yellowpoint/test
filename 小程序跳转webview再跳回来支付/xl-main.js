...
console.log('来自url的token'+GetQueryString('token'))
...
var orderConfirmPage = function() {
	...
	$('body').on('click', '.submit', function() {
		...
		$.ajax({
			...
			dataType: 'json',
			success: function(data) {
				console.log('提交成功，跳转小程序支付')
				console.log(data)
				wx.miniProgram.navigateTo({
					url: '/pages/pay?data='+ JSON.stringify(data)+'&tradeOrderId='+tradeOrderId
				})
		...
		//		alert(payChannel)
		if(payChannel == 'wx_pub') {} else if(payChannel == 'wx_wap') {} else {}
