...
(function () {
    ...
    //分裂大圆
    var CircleCenterSplit = window.CircleCenterSplit
    //弹夹剩余子弹数
    ...
    //口红资源数组
    var arrayLipstick = window.arrayLipstick;
    //中心圆资源数组
    var arrayCenterCircle = window.arrayCenterCircle;
    //关卡资源
    var levelUrl =window.levelUrl
    ...
    // 配置游戏口红的参数
    // var D_Json = JSON.parse(localStorage.getItem("gamesmain"))
    // console.log("D_Json",gamesmain)
    // debugger

    var D_Json = gamesmain
    D_Json.fail_PARAMETERS={
    ...
    CircleCenter.prototype.resetCircleCenterRotate=function (context){
        ...
        //     $("#bulletsNum1").attr("src","../addons/hc_doudou/template/mobile/img/5.png")
        //     $("#bulletsNum2").attr("src","../addons/hc_doudou/template/mobile/img/3.png")
    ...
    Game.prototype = {
        ...
        init:function (){
            ...
            ballimg.src = window.arrayCenterCircle[0];
        ...
        normalResults:function(){
            if(this.bulletCircles[BulletCirclesIndex]){
                this.bulletCircles[BulletCirclesIndex].imgObj.src = columnsLipstick[this.level-1].active;
                BulletCirclesIndex++;
        ...
        nextLevel:function (){
            ...
            if (self.level <= self.levelLength) {
               ...
               $("#levelSwitchBoxMain").attr("src", window.levels_mains[self.level-1]);
        ...
        levelChange:function (){
            ...
            for(i = 0; i < lens; i++){
                ...
                tempClipImg.src = columnsLipstick[this.level-1].normal;
